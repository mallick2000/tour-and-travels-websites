      ...
      {cabPackages.map((cab, index) => (
        ...
        >
          ...
          <div className="flex-1">
            ...
            <h2 className="text-xl font-semibold text-gray-900">{cab.title}</h2>
          ...
          <div className="flex flex-col items-end justify-between h-full">
            <div className="mt-4 text-right">
              ...
              <button className="mt-4 bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600 transition-all">
                Book Now →
              </button>
            </div>
          </div>
